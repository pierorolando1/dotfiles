...
M.config = function()
    ...
    lvim.plugins = {
        ...
        },
        {
            ...
            --     return (_time.hour >= 1 and _time.hour < 1)
            -- end,
        },
        {
            ...
            --     -- local _time = os.date "*t"
            --     return false
            --     -- return _time.hour >= 9 and _time.hour < 19
            -- end,
        },
        {
            "catppuccin/nvim",
            ...
            -- cond = function()
            --     local _time = os.date "*t"
            --     return (_time.hour >= 19 and _time.hour < 19)
            -- end,
        },
        {
            ...
            -- cond = function()
            --     local _time = os.date "*t"
            --     return (_time.hour >= 24 and _time.hour < 24) or (_time.hour >= 0 and _time.hour < 0)
            -- end,
        },
        {
